...
# 	csv_reader = csv.reader(csv_file, delimiter = ",")
# 	for row in csv_reader:
# 		data_input, label_input = row[0], row[1]
...
# 	train_acc = sess.run(accuracy, feed_dict = {input_data : train_data_sess, label = train_label_sess})
# 	val_acc = sess.run(accuracy, feed_dict = {input_data : val_data_sess, label : val_label_sess})
# 	test_acc = sess.run(accuracy, feed_dict = {input_data : test_data_sess, label : test_label_sess})
